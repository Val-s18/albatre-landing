...
className="flex flex-col md:flex-row justify-center mt-36">
  <div className='flex flex-col justify-center text-primary w-full md:w-[550px] mt-10 px-4 text-center md:text-left'>
    ...
    <div className='flex flex-col md:flex-row gap-6'>
      <Bouton texte="Nous contactez" taille='grand' variante='primaire' />
      <Bouton texte="Nos services" taille='grand' variante='outline' />
    </div>
  </div>
